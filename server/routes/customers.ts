...
import { authMiddleware, requireRole, canModify } from '../middleware/auth.js'
...
// GET /api/customers/export - Excel export (must be before /:id)
...
router.post('/', validateBody({ name: 'string', industry: 'string', region: 'string' }), async (req: AuthRequest, res: Response) => {
